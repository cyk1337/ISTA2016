	...
	<body onload = "load_result('onload')">
		<center>
			<form onsubmit="return false">
				<fieldset>
					<legend>搜索</legend>
					<input id="search_phone" type="text" placeholder="请输入手机尾号" onkeyup="search(this.value)">
					<br><br>
		...
		<script>
			...
			function load_result(result_kind){
				...
				if(result_kind == "onload"){
					...
					var value = document.getElementById("search_phone").value;

					xmlhttp.open("GET","search.php?phone="+value,true);
					xmlhttp.send();
					console.info("search.php?phone="+value);
